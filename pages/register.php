...
<div class="w-full mt-[50px] mr-[50px]">
    <div class="flex">
       ...
       <img src="../assets/image/items-one/Artboard4.png" alt="">
        ...
        <div class="flex-1 mr-[50px] md:ml-[50px]">
...
?>
 ...
 <img alt="" loading="lazy" width="100.55" height="25.69" decoding="async" data-nimg="1" style="color:transparent" src="../assets/image/icons/BOOMMINT.svg" class="mb-4">
 <div class=""> 
                <a href="index.php" float-left">
                    <img alt="" loading="lazy" width="57" height="27" decoding="async" data-nimg="1"
                         style="color:transparent" src="../assets/image/icons/back-svgrepo-com.svg">
                </a>
